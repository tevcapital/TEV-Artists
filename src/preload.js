...
contextBridge.exposeInMainWorld('desk', {
  ...
  uploadDocuments: (agentId, filePaths = null) => ipcRenderer.invoke('agent:upload-documents', { agentId, filePaths }),
  removeDocument: (agentId, docIndex) => ipcRenderer.invoke('agent:remove-document', { agentId, docIndex }),
  sendMessage: (agentId, messages, newsItems, priceData, image = null) => ipcRenderer.invoke('agent:send-message', { agentId, messages, newsItems, priceData, image }),
  startStream: (agentId, messages, newsItems, priceData, isWarRoom = false, image = null) => ipcRenderer.send('agent:start-stream', { agentId, messages, newsItems, priceData, isWarRoom, image }),
  ...
  uploadWarRoomDocuments: (filePaths = null) => ipcRenderer.invoke('warroom:upload-documents', { filePaths }),
  ...
  askAll: (question, priceData, image = null) => ipcRenderer.send('warroom:ask-all', { question, priceData, image }),
